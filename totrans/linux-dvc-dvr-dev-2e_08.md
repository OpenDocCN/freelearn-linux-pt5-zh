...
The preceding code shows the `drivers/base/platform.c`. The following code shows the I2C bus matching function, which is defined in `drivers/i2c/i2c-core.c`:
